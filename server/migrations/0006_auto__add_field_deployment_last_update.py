...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deployment.last_update'
        db.add_column('server_deployment', 'last_update',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deployment.last_update'
        db.delete_column('server_deployment', 'last_update')
