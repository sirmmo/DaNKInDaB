...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deployment.repo_type'
        db.alter_column('server_deployment', 'repo_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Deployment.repo_type'
        db.alter_column('server_deployment', 'repo_type', self.gf('django.db.models.fields.CharField')(default='git', max_length=50))
    ...
    models = {
        ...
        'server.deployment': {
            ...
            'repo': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'repo_type': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
